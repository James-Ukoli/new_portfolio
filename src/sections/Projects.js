...
const techStack1 = [reactIcon, jsIcon, javaIcon, mySQL];
...
const techStack4 = [reactIcon, jsIcon];
    ...
    <div id="projects">
      ...
      <div className="project-cards">
        ...
        <div className="card">
          ...
          <div className="project-tech-stack center1" white-robotic-text>
            Stack:{" "}
            {techStack1.map((icon) => {
          ...
          <p className="project-description center1">
        ...
        <div className="card">
          ...
          <div className="project-tech-stack center1">
            Stack:{" "}
            {techStack2.map((icon) => {
              return <img src={icon} alt={icon} />;
            })}
